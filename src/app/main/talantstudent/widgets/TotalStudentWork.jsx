...
function TotalStudentWork() {
	const classes = useStyles();
	const uniqueVisitors = 1015;
	const series = [31, 69, ];
	const labels = ["Ish bilan band talabalar", "Ish bilan band bo'lmagan talabalar"];
...
export default memo(TotalStudentWork);
